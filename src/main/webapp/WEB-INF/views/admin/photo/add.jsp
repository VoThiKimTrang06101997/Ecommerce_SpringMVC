...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<section class="content-header">
		<h1 style="color: red;">
			Add <small>Photo to ${product.productName }</small> 
		</h1>
		<ol class="breadcrumb">
			<li><a
			...
			<div class="col-md-12">
				...
				<div class="box box-primary">
					...
					<s:form method="post" modelAttribute="photo" enctype="multipart/form-data"
						action="${pageContext.request.contextPath }/admin/photo/add/${product.productId}">

						<div class="box-body">
							<div class="form-group">
								<label for="productName">File</label>
								<input type="file" name="file" />
							</div>
							
							<div class="checkbox">
								<label> <s:checkbox path="main" /> 
								Main
								</label>
							</div>
