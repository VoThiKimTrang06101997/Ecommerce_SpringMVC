...
<title>Admin Mobile Shop | Category Edit Form</title>
...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<section class="content-header">
		<h1 style="color: red;">
			Edit <small>Sub Categories</small>
		</h1>
		<ol class="breadcrumb">
			<li><a
				href="${pageContext.request.contextPath }/admin/dashboard"><i
					class="fa fa-dashboard"></i> Home</a></li>
			<li><a href="#">Edit Sub Categories</a></li>
		</ol>
	</section>
			...
			<div class="col-md-12">
				...
				<div class="box box-primary">
					...
					<s:form method="post" modelAttribute="category"
						action="${pageContext.request.contextPath }/admin/category/editsubcategories">
						...
						<div class="box-body">
							...
							<input type="hidden" name="parentCategoryId"
								value="${category.parent.categoryId}" />
