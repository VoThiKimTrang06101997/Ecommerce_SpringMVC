...
<%@ taglib prefix="mt" uri="http://localhost:9596/MobileShop"%>
...
<head>
<meta charset="utf-8">
<title>MobileStore online Shopping cart</title>
				...
				<div id="sidebar" class="span3">
					<div class="well well-small">
						<a id="myCart" href="product_summary.html"><img
							src="${pageContext.request.contextPath }/resources/user/themes/images/ico-cart.png"
